...
if __name__ == "__main__":
    ...
    # quote_id = wise_service.create_quotes(150)
    # recipient_id = wise_service.create_recipient("milenn aleks", "BG80BNBG96611020345678")
    # custom_transaction_id = str(uuid.uuid4())
    # transfer_id = wise_service.create_transfer(quote_id, recipient_id, custom_transaction_id)
    # print(quote_id)
    # print(recipient_id)
    # print(transfer_id.json())
    wise_service.cancel_transfer(51799270)


# def _get_profile_id(headers):response = requests.post(url, json=body, headers=headers)
